     ...
     <img src={assets.logo} alt='logo' className='w-36' /></Link>
      ...
      <div className={`absolute top-0 right-0 bottom-0 overflow-hidden bg-white transition-all ${visible ? 'w-full' : 'w-0'}`}>
           <div className='flex flex-col text-gray-600 '>
             ...
             <NavLink to='/' onClick={() => setVisible(false)} className='py-2 pl-6'>Home</NavLink>
             <NavLink to='/about' onClick={() => setVisible(false)} className='py-2 pl-6'>About</NavLink>
              <NavLink to='/contact' onClick={() => setVisible(false)} className='py-2 pl-6'>Contact</NavLink>
              <NavLink to='/collection' onClick={() => setVisible(false)} className='py-2 pl-6'>Collection</NavLink>
           </div>
      </div>
    </div>
  )
